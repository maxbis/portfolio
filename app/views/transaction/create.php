        ...
        <form action="<?= $GLOBALS['BASE'] ?>/transaction/store" method="POST" class="space-y-4">
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="text" name="number" class="w-20 p-1 text-sm border border-gray-300 rounded-md"
                        required>
                </div>

                <div>
                    <label class="block text-gray-700 text-sm">Price:</label>
                    <input type="text" name="amount" class="w-20 p-1 text-sm border border-gray-300 rounded-md"
                        required>
                </div>
